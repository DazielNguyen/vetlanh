        ...
        <section className="py-24" id="nguoi-dung">
            <div className="mx-auto max-w-[1200px] px-6">
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <div className="overflow-hidden rounded-3xl bg-card shadow-sm border border-border/50 transition-all hover:shadow-lg">
                        <div className="aspect-video w-full bg-secondary/30" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBkxZFzX9z4BrZ-r73k49gnULs_tpLFnxGcvtG1lRKLMD3aGPbKhAeeOrx16OVp_4bG_tHxJElObgiXNROaIPoh7ORTgZjhOyZWViax4tbeaHnWPX1Vtf9Oh6rTpZ0DA73XjWS6q8_J1tBvqGtwlB2Y6J7q-RwiElZt9kB_2-4r-S54uDLhy8EFNmAOAbzoOCfq57f892jakypri-X2gKUsFniTr2kJ19txoUcxcTJvAh6lu9SWTpVLDEKVBUmVclOtfhsUJmm2KmI")', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                        <div className="p-8">
