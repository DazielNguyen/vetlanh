        ...
        <section className="mx-auto max-w-[1200px] px-6 py-16 md:py-24">
            <div className="grid items-center gap-12 lg:grid-cols-2">
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex items-center gap-4 border-t border-primary/10 pt-8">
                        <div className="flex -space-x-3">
                            <div className="h-10 w-10 rounded-full border-2 border-background bg-secondary/20" />
                ...
                <div className="relative">
                    ...
                    <div
                        className="relative aspect-[4/3] overflow-hidden rounded-3xl bg-secondary/20 shadow-2xl"
