            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="p-8 rounded-2xl bg-background border border-gray-100 hover:shadow-xl transition-shadow group">
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed">Tìm kiếm và kết nối với đội ngũ chuyên gia tâm lý hàng đầu. Xem hồ sơ, đánh giá và đặt lịch tư vấn trực tiếp.</p>
                    </div>
                    ...
                    <div className="p-8 rounded-2xl bg-background border border-gray-100 hover:shadow-xl transition-shadow group">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-3">Trợ lý AI thông minh</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">Trò chuyện 24/7 với trợ lý AI luôn lắng nghe và thấu hiểu. Nhận phân tích cảm xúc và gợi ý bài tập phù hợp ngay lập tức.</p>
                    </div>
                    ...
                    <div className="p-8 rounded-2xl bg-background border border-gray-100 hover:shadow-xl transition-shadow group">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-3">Quản lý Lịch hẹn</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">Đặt lịch, theo dõi và quản lý các buổi tư vấn trực tuyến hoặc trực tiếp với chuyên gia một cách dễ dàng.</p>
                    </div>
                    ...
                    <div className="p-8 rounded-2xl bg-background border border-gray-100 hover:shadow-xl transition-shadow group">
                        ...
                        <h3 className="text-xl font-bold text-foreground mb-3">Theo dõi Sức khỏe</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">Biểu đồ trực quan theo dõi mức độ căng thẳng, lộ trình chữa lành cá nhân và bài tập thở giúp bạn cân bằng mỗi ngày.</p>
                    </div>
                </div>
            </div>
        </section>
