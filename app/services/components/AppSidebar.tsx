...
import { Home, Dumbbell, MessageSquare, PanelLeftClose, PanelLeftOpen, Settings, LogOut, Brain, BookOpen, Headphones, User, ShieldCheck, Smile, NotebookPen, ClipboardList, Users, type LucideIcon } from "lucide-react";
...
const navItems: Array<{ title: string; url: string; icon: LucideIcon; exact: boolean; tourId?: string; requiredLevel?: number }> = [
    ...
    { title: "Âm thanh", url: "/services/sounds", icon: Headphones, exact: false, tourId: "sounds", requiredLevel: 1 },
    { title: "Nhật ký", url: "/services/journal", icon: NotebookPen, exact: false, requiredLevel: 1 },
    ...
    { title: "Thư viện", url: "/services/library", icon: BookOpen, exact: false, tourId: "library", requiredLevel: 1 },
