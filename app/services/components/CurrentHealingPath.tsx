        ...
        <div>
            ...
            <div className="space-y-4">
                ...
                <Card className="border-none shadow-sm rounded-2xl flex items-center p-4">
                    ...
                    <div className="ml-4 flex-1">
                        <div className="flex justify-between items-center mb-1">
                            <h3 className="font-bold text-slate-800 tracking-tight">Bài tập thở nâng cao</h3>
                            <span className="text-xs font-bold text-primary">Hoàn thành 75%</span>
                        </div>
                        <Progress value={75} className="h-2 bg-slate-100 [&>div]:bg-emerald-300" />
                        <p className="text-xs text-slate-500 mt-2">Bài tập thở hàng ngày giúp điều hòa cảm xúc.</p>
                    </div>
                ...
                <Card className="border-none shadow-sm rounded-2xl flex items-center p-4 opacity-70">
                    ...
                    <div className="ml-4 flex-1">
                        <div className="flex justify-between items-center mb-1">
                            <h3 className="font-bold text-slate-800 tracking-tight">Viết nhật ký phản chiếu</h3>
                            <span className="text-xs font-bold text-slate-400">Tiếp theo: Ngày 4</span>
                        </div>
                        <Progress value={0} className="h-2 bg-slate-100" />
                        <p className="text-xs text-slate-500 mt-2">Khám phá các mẫu hình trong chu kỳ suy nghĩ của bạn.</p>
                    </div>
