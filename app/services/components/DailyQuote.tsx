...
export function DailyQuote() {
  ...
  const text =
    data?.text ?? "Chữa lành không phải đường thẳng, nhưng mỗi bước tiến đều là một chiến thắng.";
  const author = data?.author;

  return (
    <Card className="border-none shadow-md rounded-3xl bg-hero-wordmark overflow-hidden h-full">
      <CardContent className="p-8 text-left relative overflow-hidden min-h-40 h-full flex flex-col justify-center">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt=""
            fill
            className="object-cover opacity-25 sepia-[0.2]"
